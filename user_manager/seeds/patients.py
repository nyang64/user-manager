...
def seed(outpatient_provider, prescribing_provider):
    for patient_details in PATIENTS:
        create_patient(patient_details, prescribing_provider, outpatient_provider)


def create_patient(patient_details, prescribing_provider, outpatient_provider):
    ...
    if registered_user_id:
        patient = patient_schema.load({
            ...
            "emergency_contact_phone": patient_details["emergency_contact_phone"],
        ...
        # create_patient_provider(patient_id, prescribing_provider, 1)
        # create_patient_provider(patient_id, outpatient_provider, 2)
