...
from utils.common import MyEncoder, auth_response_model, toJson
from werkzeug.exceptions import BadRequest


class TestCommon:
    def test_read_environ_blank(self):
        print(read_environ_value("{'POSTGRES_DB_PORT':None}", "POSTGRES_DB_PORT"))
    ...
    def test_time_diff(self):
        ...
        resp = common.timeDiff(first_time=datetime.now(), second_time=datetime.now())
        assert resp is not None
